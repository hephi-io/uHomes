            ...
            <div className="pt-9 space-y-6">
                ...
                <div>
                    ...
                    <Select
                        ...
                        value={watch("role")}
                    >
                        <SelectTrigger className="w-full py-1 px-3 rounded-md border border-zinc-200 flex justify-between items-center bg-white"> <div className="flex gap-2 items-center"> <UserView /> <SelectValue placeholder="Select your role" /> </div> </SelectTrigger> <SelectContent className="border bg-white border-zinc-200"> <SelectGroup> <SelectLabel className="font-normal text-sm text-[#09090B]"> Property Owner </SelectLabel> <SelectItem value="owner">Property Owner</SelectItem> <SelectItem value="agent">Agent</SelectItem> <SelectItem value="tenant">Tenant</SelectItem> </SelectGroup> </SelectContent>
                    </Select>
                    {errors.role && (
