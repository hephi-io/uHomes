...
const Listing = () => {
  ...
  return (
    <div>
      {listingProperty ? (
        <div className="border border-[#F4F4F4] p-4 rounded-lg bg-[#FDFDFD]">
          <div className="grid md:grid-1 w-full lg:grid-cols-2 gap-4 ">
            <div className="flex  gap-4 items-start p-4 border border-[#F4F4F4]">
              {/* <div>need to install check box from shadcn lib</div> */}
              <div>
        ...
        <div className="border border-[#F4F4F4] p-6 rounded-lg bg-white">
