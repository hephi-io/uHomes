        ...
        <Dialog>
            ...
            <DialogContent className="md:w-[674px]   md:rounded-xl md:p-6 bg-white md:space-y-12">
                <div className="md:space-y-6">
                    <div>
                        <h2 className="font-semibold text-[18px] leading-[130%] text-[#101828]">Add New Property</h2>
                    ...
                    <div className="grid items-center grid-cols-2 gap-6">
                        <div className="flex flex-col space-y-2">
                            <Label className="text-[#09090B] font-inter font-normal text-sm">Property Title *</Label>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea placeholder="Describe the property features, location benefits, etc." className=" h-[86px] text-[#999999] font-inter text-sm leading-[130%] border border-[#E4E4E7] rounded-xl resize-none" />
                    </div>
                    <div className="space-y-2">
        ...
        `}
                            >
                                ...
                                <div className="flex flex-col items-center space-y-4">
                                    ...
                                    <p className="text-[#939393] font-normal text-sm leading-[130%]">Click to upload or drag and drop up to 10 images here.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <DialogContent className="w-[443px] rounded-[10px] border-2 border-[#3E78FF0D] bg-white p-6 space-y-9">
                ...
                <div className="w-[394px] space-y-2 mx-auto text-center">
                    ...
                    <p className="text-[#61646B] font-normal text-sm leading-5">
                        ...
                        You can now monitor bookings from your dashboard.
                    </p>
                </div>

                {/* Button */}
                <DialogFooter>
                    <Button variant='outline' className="w-full bg-[#3E78FF] hover:bg-[#3E78FF] border border-[#E4E4E4EE] py-2 px-4 rounded-[5px]">
