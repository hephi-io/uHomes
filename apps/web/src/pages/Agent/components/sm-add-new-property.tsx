    ...
    <div className="md:hidden">
      ...
      <div className="px-6 pb-12 space-y-6">
        ...
        <div className="flex flex-col space-y-2">
          <Label className="text-[#09090B] font-Bricolage font-normal text-sm">
            Property Title *
          </Label>
          <Input
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Popover open={availableOpen} onOpenChange={setAvailableOpen}>
            <PopoverTrigger asChild>
              ...
              >
                {availableValue ? frameworks2.find((f) => f.value === availableValue)?.label : '3'}
              ...
              <Popover open={roomsOpen} onOpenChange={setRoomsOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className="justify-between font-inter text-[#71717A] text-sm font-normal"
                  >
                    {roomsValue ? frameworks.find((f) => f.value === roomsValue)?.label : '150000'}
                    <ChevronsUpDown className="opacity-50" />
                  </Button>
                </PopoverTrigger>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className=" h-[118px] text-[#999999] font-inter text-sm leading-[130%] border border-[#E4E4E7] rounded-xl resize-none p-3"
          />
        </div>
        ...
        `}
            >
              ...
              <div className="flex flex-col items-center space-y-4 py-[19px]">
                ...
                <p className=" text-center text-[#939393] font-normal text-sm leading-[130%]">
