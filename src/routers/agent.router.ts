 ...
 */
router.post('/register', validate({ body: createAgentSchema}), controller.register.bind(controller));
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.get('/:id', authenticate, validate({body:getAgentByIdSchema}), controller.getById.bind(controller));
