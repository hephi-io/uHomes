 ...
 */
router.post('/register', validate({body:createUserSchema}), controller.register.bind(controller));
 ...
 */
router.get('/verify', validate({query:verifyUrlSchema}), controller.verifyAccountViaUrl.bind(controller));
 ...
 *         description: User not found
 */
router.get('/:id', authenticate, validate({params:getUserByIdSchema}), controller.getById.bind(controller));
 ...
 *         description: User not found
 */
router.delete('/:id', authenticate, validate({params:deleteUserSchema}), controller.delete.bind(controller));
